...
.e-gantt .e-gantt-chart .e-gantt-unscheduled-taskbar.e-gantt-child-manualtaskbar {
  background: -webkit-gradient(linear, left top, right top, from(rgb(209, 231, 220.8)), color-stop(30%, #198754), color-stop(70%, #198754), color-stop(70%, #198754), to(rgb(209, 231, 220.8)));
  background: linear-gradient(to right, rgb(209, 231, 220.8), #198754 30%, #198754 70%, #198754 70%, rgb(209, 231, 220.8) 100%);
}
...
.e-gantt .e-gantt-chart .e-critical-connector-line-hover {
  ...
  outline-color: rgb(248, 214.6, 217.8);
}
...
.e-gantt .e-gantt-chart .e-gantt-child-critical-taskbar-inner-div {
  ...
  outline: 1px solid rgb(248, 214.6, 217.8);
  border-radius: 4px;
}
